...
def main() -> None:
    ...
    if args.model == "InvariantMACE":
        model = modules.InvariantMACE(
            **model_config,
    ...
    elif args.model == "RealScaleShiftNonLinearBodyOrderedModel":
        mean, std = modules.scaling_classes[args.scaling](train_loader, atomic_energies)
        model = modules.RealScaleShiftNonLinearBodyOrderedModel(
            **model_config,
            correlation=args.correlation,
            gate=gate_dict[args.gate],
            interaction_cls_first=modules.interaction_classes[args.interaction_first],
    ...
    elif args.model == "EquivariantRealScaleShiftNonLinearBodyOrderedModel":
        mean, std = modules.scaling_classes[args.scaling](train_loader, atomic_energies)
        model = modules.EquivariantRealScaleShiftNonLinearBodyOrderedModel(
            **model_config,
            correlation=args.correlation,
            gate=gate_dict[args.gate],
            interaction_cls_first=modules.interaction_classes[args.interaction_first],
