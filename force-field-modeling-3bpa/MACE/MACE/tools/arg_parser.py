...
def build_default_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--model',
                        help='model type',
                        default='InvariantMACE',
                        choices=['InvariantMACE','scale_shift_non_linear','BOTNet','scale_shift_BOTNet','EquivariantRealScaleShiftNonLinearBodyOrderedModel','RealScaleShiftNonLinearBodyOrderedModel'])
